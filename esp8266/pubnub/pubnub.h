...
// Callback for connection to PubNub
typedef void (*Pubnub_connectedCB)(void);

// Callback for connection errors
//typedef void (*Pubnub_connErrorCB)(sint8 error);
typedef void (*Pubnub_connErrorCB)(sint8 err);
...
typedef struct pubnub {
	...
	Pubnub_connectedCB	connectedCB;
	Pubnub_connErrorCB	connErrorCB;
